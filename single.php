...
.single-post-wrapper {
        ...
        max-width: 1200px;
        margin: 40px auto;
        justify-content: space-between; /* Replaces static gap to prevent wrapping */
        padding: 0 20px;
    }
    .single-main-content {
        flex: 0 0 65%; /* Strictly enforces width */
        max-width: 65%;
    }
    .single-sidebar {
        flex: 0 0 30%; /* Strictly enforces width */
        max-width: 30%;
    }
	...
	/* Force Table of Contents Links to Show */
	.ez-toc-container a,
	.ez-toc-link,
